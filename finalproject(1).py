...
cmd_dir2 = 'mkdir images' + current
#create a directory search filters
cmd_dir3 = 'mkdir search_filters' + current
print("                                ")
print("*******************************************")
print('New DIRECTORIES with "CURRENT TIME" Created')
print("*******************************************")
print("                                 ")
...
# parse all http traffic and save to search filters directory 
cmd5 = 'tshark -r ' + str(file_name) + ' -Y http | sort -n >> ~/finalproject/search_filters' + current + '/HTTPtraffic.log' + current
...
cmd7 = 'tshark -r ' + str(file_name) + ' --export-object smb,/home/kali/finalproject/exports' + current + '> /dev/null'
#export imf objects
cmd8 = 'tshark -r ' + str(file_name) + ' --export-object imf,/home/kali/finalproject/exports' + current + '> /dev/null'
...
print("                     ")
print("---------------------")
print("ALL/ANY HTTP TRAFFIC moved to 'search_filters' Directory")
print("---------------------")
...
print("                                                ")
print("************************************************")
print("HTTP OBJECTS EXPORTED TO RECENT EXPORTS DIRECTORY")
print("************************************************")
print("************************************************")
print("SMB OBJECTS EXPORTED TO RECENT EXPORTS DIRECTORY")
print("************************************************")
print("************************************************")
print("IMF OBJECTS EXPORTED TO RECENT EXPORTS DIRECTORY")
print("************************************************")
...
cmd_mv_filters = 'mv ARP* ICMP* PORT* SSH* SYN* UDP* XMAS* -t ~/finalproject/search_filters' + current
...
print("**************************************************************")
print("ALL SEARCH FILTER LOGS SENT TO RECENT SEARCH FILTERS DIRECTORY")
print("**************************************************************")
print("**************************************************************")
print("ANY IMAGES SENT RECENT IMAGES DIRECTORY")
print("**************************************************************")

#change to exports directory
path = '/home/kali/finalproject/exports' + current
#move images to images directory, if no images exist errors will be redirected to dev/null
cmd_mv_images = 'mv *.gif *.jpg *.png -t /home/kali/finalproject/images' + current + '> /dev/null 2>&1'
#call os commands
os.chdir(path)
